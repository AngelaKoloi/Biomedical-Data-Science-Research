...
#Import data 
data_resid <- read.csv("residualized_data.csv")
...
# Run  MGM model and do prediction
set.seed(123)
...
write.table(adjacency_df, "adjacency_matrix.csv", sep = ",", col.names = FALSE, row.names = FALSE)
...
node_labels <- c('Alanine','Glutamine','Histidine','Isoleucine','Leucine','Phenylalanine','Tyrosine',
                 'Valine','Apolipoprotein A-I','Apolipoprotein B','Esterified cholesterol','Free cholesterol',
                 ...
                 'Guilty feelings','Punishment feelings',
                 'Self-dislike','Self-criticalness',
                 'Suicidal thought or wishes', 'Crying',
                 'Agitation','Loss of interest', 'Indecisiveness',
                 'Worthlessness', 'Loss of energy',
                 'Changes in sleep pattern','Irritability',
